...
$selcam = "SELECT DISTINCT campus.name,campus.campus_id,department.d_id,department.d_name,faculty.id,faculty.fname FROM university,campus,faculty,department,programme WHERE university.id = campus.university_id AND campus.campus_id = faculty.c_id AND faculty.id = department.faculty_id AND department.d_id = programme.d_id AND campus.campus_id ='$id' ";
              ...
              <div class='invoice-print'>
                <div class='row mt-4'>
                  <div class='col-md-12'>
                    ...
                    <p class='section-lead'>Campuses: <?php echo $cname;?> >> Faculty</p>
                    <div class="table-responsive">
                      ...
                      <?php
                        ...
                        $xfeed++;
                        $ency = base64_encode($did);

                    echo"
                         <tr>
                          <td>$xfeed</td>
                          <td>$fnames</td>
                          <td><a href = 'DetailsDept.php?xx=$ency'><i class = 'fas fa-eye'>&nbsp;</i></a></td>
                         </tr>
                      ";
                         }
                      ?>
