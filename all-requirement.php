              ...
              <div class='invoice-print'>
                <div class='row mt-4'>
                  <div class='col-md-12'>
                    ...
                    <p class='section-lead'>General Requiremets for all programmes</p>
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
                        <thead>
                          <tr>
                            <th>S/n</th>
                            <th> <center>Requirements</center></th>
                            <th>Created at</th>
                          </tr>
                        </thead>
                        <tbody>
                      ...
                      //campus & faculty..
                      $id = base64_decode($_GET['xxx']);
                      $selcam = "SELECT * FROM university,gen_requirement WHERE university.id = gen_requirement.university_id AND  university.university_name='$id'";
