...
$sel = "SELECT * FROM university,campus,faculty WHERE university.id = campus.university_id AND campus.campus_id = faculty.c_id AND faculty.id = '$id'";
$run = mysql_query($sel);
                     ...
                     <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <select class="form-control selectric" name="cname">
                          <?php
                          require_once('dbconnection.php');
                          $sel = "SELECT * FROM campus ORDER BY name";
                          $sql = mysql_query($sel);
                          while ($rows = mysql_fetch_array($sql)) {
                            $cname = $rows['name'];
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="submit" name="save" class="btn btn-primary" value="Edit-faculty">
                      </div>
                    </div>
                    </form>
                  </div>
