...
if (isset($_POST['save'])) {
  ...
  $check = "SELECT * FROM organization_type WHERE name = '$org'";
  $run_check = mysql_query($check);
  $count = mysql_num_rows($run_check);

  if ($count==1) {
    $error3 = "<div class='alert alert-danger alert-has-icon'>
                         That particular Organization Type has been already added to the system, you can not add twice..
                         </div>";
  }
  ...
  $sql = "INSERT INTO organization_type (org_name,created_at) VALUES ('$org','$time')";
  $run = mysql_query($sql);
...
<head>
  ...
  <title>uims - Add Organization</title>
  <!-- General CSS Files -->
  <!-- General CSS Files -->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Add Organization Type</h4>
                  </div>
                  <div class="card-body">
                    <?php echo $msg; echo $error2;  echo $error3;?>
                    <form method="POST" action="">
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Organization Name:</label>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="submit" name="save" class="btn btn-primary" value="Create-organization">
                      </div>
                    </div>
                    </form>
