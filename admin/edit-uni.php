...
$sel = "SELECT university.id,university.university_name,university.location,university.org_type_id,university.website,university.contact,university.phy_address,organization_type.org_type_id,organization_type.org_name FROM university LEFT JOIN organization_type ON university.org_type_id = organization_type.org_type_id WHERE university.id = '$id'";
$run = mysql_query($sel);
$fetch = mysql_fetch_array($run);
$uid = $fetch['id'];
$uname = $fetch['university_name'];
$lo = $fetch['location'];
$oid = $fetch['org_type_id'];
$web = $fetch['website'];
$cont = $fetch['contact'];
...
<head>
  ...
  <title>uims - Edit University</title>
  <!-- General CSS Files -->
  <!-- General CSS Files -->
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form method="POST" action="edit-uni-query.php">
                    ...
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Organization Type:</label>
                      <div class="col-sm-12 col-md-7">
                        <select class="form-control selectric" name="org">
                          <option>--select--</option>
                          <?php
                          require_once('dbconnection.php');
                          $sel = "SELECT * FROM organization_type ORDER BY org_name ";
                          $sql = mysql_query($sel);
                          while ($rows = mysql_fetch_array($sql)) {
                            $oname = $rows['org_name'];
                            $oid = $rows['org_type_id'];
                     ...
                     <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control" name="con" value="<?php echo $cont;?>">
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Physical Address</label>
                      <div class="col-sm-12 col-md-7">
                        <textarea class="summernote-simple" name="phy" value = "<?php echo $phy;?>"></textarea>
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"></label>
                      <div class="col-sm-12 col-md-7">
                        <input type="submit" name="save" class="btn btn-primary" value="Edit-university">
                      </div>
                    </div>
                    </form>
