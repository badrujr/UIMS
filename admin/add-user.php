...
if (isset($_POST['save'])) {
  ...
  $name = mysql_escape_string(trim(strip_tags($_POST['fname'])));
  ...
  if ($pos == "--select--") {
      $error2 = "<div class='alert alert-danger alert-has-icon'>
                         Please select position, $pos is not allowed...
                         </div>";
  }

  else{
  
  $sql = "INSERT INTO users (name,email,password,telephone,pos,activation) VALUES ('$name','$email','$pass','$tele','$pos','no')";
  $run = mysql_query($sql);
                  ...
                  <div class="card-body">
                    ...
                    <form name="" action="" method="POST">
                     ...
                     <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control inputtags" name="tele">
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Position:</label>
                      <div class="col-sm-12 col-md-7">
                        <select class="form-control selectric" name="pos">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="submit" name="save" class="btn btn-primary" value="Create user">
                      </div>
                    </div>
                    </form>
