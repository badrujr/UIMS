...
$now=date('h:i:s A',time());
    ...
    $datez=$d."/".$m."/".$y;
    $select1 = "SELECT DISTINCT user FROM visited";
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      while ($rows = mysql_fetch_assoc($run1)) {
                          $names = $rows['user'];
                          $selectb = "SELECT * FROM visited WHERE user='$names'";
                          $runb = mysql_query($selectb);
                          $rowsn = mysql_fetch_assoc($runb);
                          $x++;
                          $id = $rowsn['id'];
                          $user = $rowsn['user'];
                          $tit = $rowsn['title'];
                      ...
                      <td>$tit</td>
                      <td>$act</td>
                      <td><a href='get_info.php?xx=$data'><i class='fas fa-eye'></i></a></td>
                      </tr>
                        ";
                      }
                      ?>
