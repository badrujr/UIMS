...
$sel = "SELECT * FROM users WHERE uid = '$id'";
$run = mysql_query($sel);
...
$email = $fetch['email'];
$pass = $fetch['password'];
$tele = $fetch['telephone'];
$act = $fetch['activation'];
$pos = $fetch['pos'];
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Edit System User: <?php echo $jina;?> Position: <?php echo $pos;?>  Activation: <?php echo $act;?></h4>
                  </div>
                  <div class="card-body">
                    <?php echo $msg; echo $error; echo $error2; ?>
                    <form name="" action="edit-user-query.php" method="POST">
                      <input type="hidden" name="uid" value="<?php echo $uid;?>">
                        <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Name:</label>
                      <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control" name="fname" value="<?php echo $jina;?>">
                      </div>
                    </div>
                     <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Email:</label>
                      <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control inputtags" name="email" value="<?php echo $email;?>">
                      </div>
                    </div>
                     <div class="form-group row mb-4">
                     ...
                     <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control inputtags" name="tele" value="<?php echo $tele;?>">
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Position:</label>
                      <div class="col-sm-12 col-md-7">
                        <select class="form-control selectric" name="pos" value="<?php echo $pos;?>">
                     ...
                     <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Activation:</label>
                      <div class="col-sm-12 col-md-7">
                        <select class="form-control selectric" name="act" value="<?php echo $act;?>">
                          <option>--select--</option>
                          <option>yes</option>
                          <option>no</option>
                        </select>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="submit" name="save" class="btn btn-primary" value="Edit user">
                      </div>
                    </div>
                    </form>
