                ...
                <div class="card author-box">
                  <div class="card-body">
                    <div class="author-box-center">
                      <img alt="image" src="assets/img/users/index.png" class="rounded-circle author-box-picture">
                    ...
                    <div class="text-center">
                      ...
                      <div class="mb-2 mt-3">
                        <div class="text-small font-weight-bold">Follow <?php echo $name;?> On</div>
                      </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <ul class="list-unstyled user-progress list-unstyled-border list-unstyled-noborder">
                      ...
                      <li class="media">
                        <div class="media-body">
                          <div class="media-title">Web Application Development</div>
                        </div>
                        <div class="media-progressbar p-t-10">
                          <div class="progress" data-height="6">
                      ...
                      <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="home-tab2">
                        <div class="row">
                          ...
                          <div class="col-md-3 col-6 b-r">
                            ...
                            <br>
                            <p class="text-muted">(+255) 717 22 56 37</p>
                          </div>
                          <div class="col-md-3 col-6 b-r">
                            <strong>Email</strong>
                            <br>
                        ...
                        <p class="m-t-30">Completed my graduation in computer science from the well known and
                          renowned Arusha Technical College, Tanzania in 2017-20, which was
                          affiliated
                        ...
                        <ul>
                          <li>Ordinary level certificate, Dar es salaam, Tanzania.</li>
                           <li>Ordinary Diploma in Computer science, Arusha, Tanzania.</li>
                          <li>Bachelor Degree., Shaurashtra University, Rajkot</li>
                        </ul>
