...
$sel  = "SELECT * FROM university,campus,faculty,department WHERE university.id = campus.university_id AND campus.campus_id = faculty.c_id AND faculty.id = department.faculty_id AND department.d_id = '$id'";
$run = mysql_query($sel);
$info = mysql_fetch_array($run);
$did = $info['d_id'];
$uname = $info['university_name'];
$cname = $info['name'];
$fname = $info['fname'];
$dname = $info['d_name'];
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form method="POST" action="edit-faculty-query.php">
                      <input type="hidden" name="did" value="<?php echo $did;?>">
                             <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">University Name:</label>
                      <div class="col-sm-12 col-md-7">
                        <select class="form-control selectric" name="uname" value = "<?php echo $uname;?>">
                          <?php
                          require_once('dbconnection.php');
                          "SELECT * FROM university,campus,faculty,department WHERE university.id = campus.university_id AND campus.campus_id = faculty.c_id AND faculty.id = department.faculty_id AND department.d_id = '$id'";
                          $sel = "SELECT DISTINCT university_name FROM university";
                          $sql = mysql_query($sel);
                     ...
                     <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="submit" name="save" class="btn btn-primary" value="Edit-department">
                      </div>
                    </div>
                    </form>
                  </div>
