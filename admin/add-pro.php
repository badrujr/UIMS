...
if (isset($_POST['prog'])) {
  ...
  if ($cname == "--select--") {
    ...
    $fac = "SELECT * FROM faculty INNER JOIN department ON faculty.id = department.faculty_id WHERE department.d_name = '$dname'"; 
    ...
    $sql = "INSERT INTO programme (pro_name,created_at,d_id) VALUES ('$pro','$created_at','$did')";
    $run = mysql_query($sql);

  if ($run) {
    $msg = "<div class='alert alert-success alert-has-icon'>
                         Programme details have been added successfully...
                         </div>";
    ...
    $error = "<div class='alert alert-danger alert-has-icon'>
                         Unable to add Programme details...
                         </div>";
  }
...
<head>
  ...
  <title>uims - Add Programmes</title>
  <!-- General CSS Files -->
  <!-- General CSS Files -->
...
<body>
  ...
  echo "<div class='form-group row mb-4'>
          <label class='col-form-label text-md-right col-12 col-md-3 col-lg-3'>Programme Name:</label>
          <div class='col-sm-12 col-md-7'>
        ...
        <div class='form-group row mb-4'>
          <label class='col-form-label text-md-right col-12 col-md-3 col-lg-3'></label>
          <div class='col-sm-12 col-md-7'>
            <input type='submit' name='prog' class='btn btn-primary' value='create-programme'>
          </div>
        </div>";   
