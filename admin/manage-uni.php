...
<head>
  ...
  <title>uims - Manage University</title>
  <!-- General CSS Files -->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>List Of All Universities</h4>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
                        ...
                        <tbody>
                              <?php
                       require_once('dbconnection.php');
                       $sel = "SELECT university.id,university.university_name,university.location,university.website,university.contact,university.phy_address,organization_type.org_name FROM university INNER JOIN organization_type ON university.org_type_id = organization_type.org_type_id  ORDER BY university_name ASC";
                       $run = mysql_query($sel);
                       $x = 0;
                       ...
                       while ($rows = mysql_fetch_array($run)) {
                         ...
                         echo"<tr>
                          ...
                          <td>$cont</td>
                          <td>$phy</td>
                          <td><a href = 'edit-uni.php?xx=$enc'><i data-feather='edit'></i></a></td>
                          <td><a href = 'verify-uni.php?xx=$enc'><i data-feather='trash'></i></a></td>
                         </tr>";
                       }
