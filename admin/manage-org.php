...
<head>
  ...
  <title>uims - Manage Organization</title>
  <!-- General CSS Files -->
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
                        ...
                        <tbody>
                              <?php
                       require_once('dbconnection.php');
                       $sel = "SELECT * FROM organization_type ORDER BY org_name ASC";
                       $run = mysql_query($sel);
                       $x = 0;
                       ...
                       while ($rows = mysql_fetch_array($run)) {
                         ...
                         echo"<tr>
                          ...
                          <td>$oname</td>
                          <td>$created</td>
                          <td><a href = 'edit-org.php?xx=$enc'><i data-feather='edit'></i></a></td>
                          <td><a href = 'verify-org.php?xx=$enc'><i data-feather='trash'></i></a></td>
                         </tr>";
                       }
