            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form name="" action="delete-user-query.php" method="POST">
                      <input type="hidden" name="uid" value="<?php echo $uid;?>">
                        <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Name:</label>
                      <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control" name="fname" value="<?php echo $jina;?>" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="d-block">
                      <div class="float-right">
                        <a href="manage-user.php" class="text-small" style="text-decoration: none; color: green;">
                          No! Go Back
                        </a>
                      </div>
                    </div>
