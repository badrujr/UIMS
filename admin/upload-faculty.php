...
while(($myData = fgetcsv($handle,1000,',')) !== FALSE){
    ...
    $fname = mysql_real_escape_string(trim(strip_tags($myData[0])));
    $cid = mysql_real_escape_string(trim(strip_tags($myData[1])));
    
    $created_at = date('Y/m/d H:i:s');

    $query = "insert into faculty (fname,created_at,c_id) values ('".$fname."','".$created_at."','".$cid."')";
...
if(!$run){
  ...
  $sms = "<div class='alert alert-success alert-dismissible'>
      <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button> Faculty details have been uploaded Successfully!
      </div>";
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Upload Faculty details Via Csv or Excel Files...</h4>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                       <input type="submit" name="uploadBtn" class="btn btn-primary" value="Upload-faculty">
                      </div>
                    </div>
                  </div>
                </div>
