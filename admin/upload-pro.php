...
while(($myData = fgetcsv($handle,1000,',')) !== FALSE){
    ...
    $pname = mysql_real_escape_string(trim(strip_tags($myData[0])));
    $pid = mysql_real_escape_string(trim(strip_tags($myData[1])));
    
    $created_at = date('Y/m/d H:i:s');

    $query = "insert into programme (name,created_at,d_id) values ('".$pname."','".$created_at."','".$pid."')";
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Upload Programmes details Via Csv or Excel Files...</h4>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                       <input type="submit" name="uploadBtn" class="btn btn-primary" value="Upload-programme">
                      </div>
                    </div>
                  </div>
                </div>
