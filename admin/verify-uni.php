...
$sel = "SELECT * FROM university WHERE id = '$id'";
$run = mysql_query($sel);
$fetch = mysql_fetch_array($run);
$uid = $fetch['id'];
$jina = $fetch['university_name'];
...
<head>
  ...
  <title>uims - Verify University</title>
  <!-- General CSS Files -->
  <!-- General CSS Files -->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Are You Sure You Want To Remove This University/Institution/College?</h4>
                  </div>
                  <div class="card-body">
                    <form name="" action="delete-uni-query.php" method="POST">
                      <input type="hidden" name="uid" value="<?php echo $uid;?>">
                        <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Name:</label>
                      <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control" name="uname" value="<?php echo $jina;?>" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="submit" name="save" class="btn btn-danger" value="Yes! Remove">
                      </div>
                    </div>
                      <div class="d-block">
                      <div class="float-right">
                        <a href="manage-uni.php" class="text-small" style="text-decoration: none; color: green;">
                          No! Go Back
                        </a>
                      </div>
                    </div>
