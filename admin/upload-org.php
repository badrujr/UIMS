...
while(($myData = fgetcsv($handle,1000,',')) !== FALSE){
    $org = mysql_real_escape_string(trim(strip_tags($myData[0])));
    $created_at = date('Y/m/d H:i:s');
  $query = "insert into organization_type (name,created_at) values ('".$org."','".$created_at."')";
...
if(!$run){
  ...
  $sms = "<div class='alert alert-success alert-dismissible'>
      <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button> Organization Type has been uploaded Successfully!
      </div>";
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Upload Organization Types Via Csv or Excel Files...</h4>
                  </div>
