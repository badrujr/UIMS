...
$sel = "SELECT * FROM organization_type WHERE org_type_id = '$id'";
$run = mysql_query($sel);
...
<head>
  ...
  <title>uims - Edit Organization</title>
  <!-- General CSS Files -->
  <!-- General CSS Files -->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Edit Organization Type: <?php echo $oname;?></h4>
                  </div>
                  <div class="card-body">
                    <?php echo $msg; echo $error2;?>
                    <form method="POST" action="edit-org-query.php">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="submit" name="save" class="btn btn-primary" value="Edit-organization">
                      </div>
                    </div>
                    </form>
