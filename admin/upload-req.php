...
while(($myData = fgetcsv($handle,1000,',')) !== FALSE){
    $university_id = mysql_real_escape_string(trim(strip_tags($myData[0])));
    $cont = mysql_real_escape_string(trim(strip_tags($myData[1])));
    $created_at = date('Y/m/d H:i:s');
    $query = "insert into requirements (university_id,content,created_at) values ('".$university_id."','".$cont."','".$created_at."')";
...
if(!$run){
  ...
  $sms = "<div class='alert alert-success alert-dismissible'>
      <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button> Requirements have been uploaded Successfully!
      </div>";
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Upload Requirements For Particular Programme Via Csv or Excel Files...</h4>
                  </div>
