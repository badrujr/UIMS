              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Manage General Requirements To Join</h4>
                  </div>
                  <div class="card-body">
                     <a class="btn btn-primary" href="user-report.php" style="float: right;">PDF Document</a>
                      <br>
                      <br>
                      <br>
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
                        <thead>
                          <tr>
                            <th>S/n</th>
                            <th>University/Institution/College</th>
                            <th>Contents</th>
                            <th>Edit</th>
                            <th>Remove</th>
                          </tr>
                        ...
                        <tbody>
                          <?php
                       require_once('dbconnection.php');
                       $sel = "SELECT university.university_name,gen_requirement.content,gen_requirement.id FROM university INNER JOIN gen_requirement ON university.id = gen_requirement.university_id ORDER BY gen_requirement.created_at";
                       $run = mysql_query($sel);
                       $x = 0;

                       while ($rows = mysql_fetch_array($run)) {
                         $id = $rows['id'];
                         $university = $rows['university_name'];
                         $cont = $rows['content'];
                         ...
                         echo"<tr>
                          ...
                          <td>$university</td>
                          <td>$cont</td>
                          <td><a href = 'edit-all-reg.php?xx=$enc'><i class = 'fas fa-edit'></i></a></td>
                          <td><a href = 'verify-all-reg.php?xx=$enc'><i class = 'fas fa-trash' style = 'color: red;'></i></a></td>
                         </tr>";
                       }
