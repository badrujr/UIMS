...
if(!in_array($fileExtension, $allowedType))
{
  $error = "<!-- Alerts-->
              ...
              <!-- /Alerts-->";
              header('Refresh:3; URL=manage-camp.php');
...
while(($myData = fgetcsv($handle,1000,',')) !== FALSE){
    ...
    $cname = mysql_real_escape_string(trim(strip_tags($myData[0])));
    $uid = mysql_real_escape_string(trim(strip_tags($myData[1])));
    
    $created_at = date('Y/m/d H:i:s');

    $query = "insert into campus (name,created_at,university_id) values ('".$cname."','".$created_at."','".$uid."')";
...
if(!$run){
  ...
  $sms = "<div class='alert alert-success alert-dismissible'>
      <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button> Campus details have been uploaded Successfully!
      </div>";
...
<head>
  ...
  <title>uims - Upload campus</title>
  <!-- General CSS Files -->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Upload Campus details Via Csv or Excel Files...</h4>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                       <input type="submit" name="uploadBtn" class="btn btn-primary" value="Upload-campus">
                      </div>
                    </div>
                  </div>
                </div>
